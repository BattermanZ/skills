...
- **[code-review](./code-review/SKILL.md)** — Two-axis review of committed and work-in-progress changes since a fixed point: **Standards** (does it follow the repo's coding standards, plus a Fowler smell baseline?) and **Spec** (does it faithfully implement the originating issue/spec?), run as parallel sub-agents.
