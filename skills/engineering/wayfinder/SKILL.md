...
Before any other action, find and read every `AGENTS.local.md` available in the current repository. Finish reading all of them before investigating, querying the tracker, or changing anything.
