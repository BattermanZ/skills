...
- **[implement](./skills/engineering/implement/SKILL.md)** — Claim one GitHub issue (or take a supplied spec), implement it, review it, prove it against the live test environment, complete its checklist, then commit, push, and close it.
...
- **[code-review](./skills/engineering/code-review/SKILL.md)** — Two-axis review of committed and work-in-progress changes since a fixed point: **Standards** (does it follow the repo's coding standards, plus a Fowler smell baseline?) and **Spec** (does it faithfully implement the originating issue/spec?), run as parallel sub-agents so neither pollutes the other.
