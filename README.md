...
- **[implement](./skills/engineering/implement/SKILL.md)** — Claim one issue (or take a supplied spec), implement it, review it, prove it against the live test environment, complete its checklist, then commit, push, and close it.
